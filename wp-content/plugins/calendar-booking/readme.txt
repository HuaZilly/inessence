=== Booking Calendar - Appointment booking for WordPress ===
Contributors: startbooking
Tags: booking system, availability calendar, calendar, appointment booking, google calendar, booking calendar, calendar booking, appointments, scheduling, group booking, booking, booking form, fitness booking, fitness scheduling, class scheduling, class booking, class calendar, group classes, yoga scheduling, yoga classes, salon scheduling, salon booking form, salon appointments, barbers, salon calendar, med spa scheduling, med spa booking, booking for med spas, appointment calendar for spa, appointmenets for salon
Requires at least: 5.0
Tested up to: 5.8
Stable tag: 3.2.13
License: GNU General Public License v2.0 or later

The best booking calendar plugin for WordPress. Appointment booking directly from your WordPress website.

== Description ==

= WordPress Booking Calendar Plugin =

At Start Booking, we believe that a simple online booking experience is critical to any highly converting website. <a href="https://www.startbooking.com/?utm_source=wprepo&utm_medium=link&utm_campaign=plugindescription" rel="friend" title="Start Booking">Start Booking</a> is a WordPress booking calendar plugin that is focused on helping individuals and businesses manage customers, book more appointments, and sell their services.
...
- Single Sign On to StartBooking.com application
= 3.0.5 Jan 20th 2021 =
