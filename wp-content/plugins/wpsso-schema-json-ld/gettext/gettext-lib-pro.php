 ...
 */
_x( 'Schema JSON-LD Markup / Google Rich Results', 'metabox title', 'wpsso-schema-json-ld' );
...
_x( '%1$s How-To Step or %2$s Step Group / Section:', 'option label', 'wpsso-schema-json-ld' );
...
_x( '%1$s Recipe Instruction or %2$s Instruction Group / Section:', 'option label', 'wpsso-schema-json-ld' );
_x( 'Name', 'option label', 'wpsso-schema-json-ld' );
_x( 'Description', 'option label', 'wpsso-schema-json-ld' );
_x( 'Image ID', 'option label', 'wpsso-schema-json-ld' );
...
_x( 'Job Location Type', 'option label', 'wpsso-schema-json-ld' );
...
_x( 'Place Information', 'metabox title', 'wpsso-schema-json-ld' );
_x( 'Select a Place', 'option label', 'wpsso-schema-json-ld' );
_x( 'Product Information', 'metabox title', 'wpsso-schema-json-ld' );
_x( 'Product Type', 'option label', 'wpsso-schema-json-ld' );
_x( 'Product Brand', 'option label', 'wpsso-schema-json-ld' );
_x( 'Product Price', 'option label', 'wpsso-schema-json-ld' );
// translators: Please ignore - translation uses a different text domain.
__( 'for simple or main product' );
_x( 'Product Availability', 'option label', 'wpsso-schema-json-ld' );
_x( 'Product Condition', 'option label', 'wpsso-schema-json-ld' );
_x( 'Product Material', 'option label', 'wpsso-schema-json-ld' );
_x( 'Product Color', 'option label', 'wpsso-schema-json-ld' );
_x( 'Product Target Gender', 'option label', 'wpsso-schema-json-ld' );
_x( 'Product Size', 'option label', 'wpsso-schema-json-ld' );
_x( 'Product Weight', 'option label', 'wpsso-schema-json-ld' );
...
_x( 'Product ISBN', 'option label', 'wpsso-schema-json-ld' );
_x( 'Schema JSON-LD Markup / Google Rich Results', 'metabox title', 'wpsso-schema-json-ld' );
_x( 'Maximum Images', 'option label', 'wpsso-schema-json-ld' );
_x( 'Image ID', 'option label', 'wpsso-schema-json-ld' );
_x( 'or an Image URL', 'option label', 'wpsso-schema-json-ld' );
