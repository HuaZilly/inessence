		...
		<div class="row" id="reviews" >
			<div class="col-lg-12 columns">
                <div class="yotpo yotpo-main-widget"
                     data-product-id="<?= $product->bc_id()?>"
                     data-price="<?= $product->price_range() ?>"
                     data-currency="AU"
                     data-name="<?= $product->name ?>"
                     data-url="<?php the_permalink(); ?>"
                     data-image-url="<?= get_the_post_thumbnail_url()?>">
                </div>
			</div>
		</div>		
...
<?php endif;?>
	...
	<?php
		...
		<div itemprop="review" itemscope itemtype="http://schema.org/Review" style="display: none;">
			...
			<meta itemprop="name" content="<?php echo $productreview['title']; ?>">
			<meta itemprop="author" content="<?php echo $productreview['author_name']; ?>">
			<meta itemprop="datePublished" content="<?php echo explode(" ", $productreview['date_reviewed'])[0]; ?>">
			
			<div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" style="display: none;">
				
				<meta itemprop="worstRating" content="1">
				<meta itemprop="bestRating" content="5">
				<meta itemprop="ratingValue" content="<?php echo $productreview['rating']; ?>">
