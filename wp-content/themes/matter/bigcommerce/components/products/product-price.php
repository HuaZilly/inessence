...
<div style="display: none"><?php print_r($discounted_category); ?></div>
...
<?php if ( $retail_price && !has_term($discounted_category_name, 'bigcommerce_category') ) { ?>
    <!-- class="bc-product__retail-price" is required --><!-- class="bc-product__retail-price-value" is required -->
    <span class="bc-product__retail-price"><?php _e( 'MSRP:', 'bigcommerce' ); ?> <span class="bc-product__retail-price-value"><?php echo esc_html( $retail_price ); ?></span></span>
    ...
    <?php if(is_single() && has_term($discounted_category_name, 'bigcommerce_category')) { ?>
		...
		<span class="bc-product__price bc-product__price--sale">
			<?php 
				...
				$salePriceSend = floor(($customer_sale_price*100))/100;
				echo '$'.round(($customer_sale_price*100)/100,2);
			?>
		</span>
    <?php } else { ?>
